    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-green-600 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <h1 className="text-3xl font-bold">美国会员折扣网络</h1>
          </div>
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">美国会员折扣网络</h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            加入BuildBridge美国会员折扣网络，享受集团采购优势，获得专业配件折扣优惠
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-20">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              我们精选了美国最优质的会员折扣，涵盖您生活，服务，建筑和装修项目所需的几乎所有配件。
            </p>
            <p className="text-gray-600">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/suppliers/usa" className="hover:text-white">美国会员折扣</Link></li>
